export default {
  ...
  run: async (client, m, args, usedPrefix, command) => {
    try {
      ...
      const newPack = { id: Date.now().toString(), lastModified: Date.now().toString(), name, author: 'Ig: Lzzin.xyz', desc: `Paquete de stickers creado por ${dev}`, stickers: [], spackpublic: 0 }
      packs.push(newPack)
